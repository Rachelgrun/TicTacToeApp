...
namespace TicTacToeTest
{
    public class Tests
    {
        ...
        public void TesrXWinsFirstRow()
        {
            ...
            TestContext. TestContext.WriteLine(game.Message);WriteLine(game.SpotsReport);
        ...
        [TestCase(3, 0, 4, 6, 5)]
        [TestCase(6, 3, 7, 0, 8)]
        public void TesrXWinsHorizantal(int x0, int o0, int x1, int o1, int x2)
        {
            TicTacToe game = new TicTacToe();
            TestContext.WriteLine("PLayAgainstComputer = " + game.PlayAgainstComputer.ToString());
            game.StartGame();
